...
# Lesson content (relative to this file → intervention/prototypes/teacher_dashboard_python)
BASE_DIR = Path(__file__).parent
LESSON_DIR = BASE_DIR.parent / "prototypes" / "teacher_dashboard_python" / "data" / "lesson_content"
