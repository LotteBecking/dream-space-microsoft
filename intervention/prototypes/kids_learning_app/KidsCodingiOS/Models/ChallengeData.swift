...
enum ChallengeData {
    static let all: [Challenge] = [
        ...
        Challenge(id: "loops-1", title: "Repeat the Action", description: "Understanding loops", difficulty: .beginner, category: "Loops", points: 15, question: "If you clap 3 times, then repeat that 2 times, how many claps total?", options: ["3", "5", "6", "9"], correctAnswer: 3, explanation: "You clap 3 times, twice. That's 3 + 3 + 6 = 9 claps!", ageGroup: "8-12"),
