...
const exercise = lesson.studentExercises[1]

export default function Exercise2Screen() {
  return (
    <div className="ds-screen">
      <StickyHeader title="EXERCISE 2" backTo="/exercise/1" />
      <SpeechBubble>Drag the cards into the right order. Sequence matters!</SpeechBubble>
      ...
      <SortingExercise exercise={exercise} />
      <div style={{ height: 80 }} />
    </div>
  )
}
